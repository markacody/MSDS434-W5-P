...
def test_api_groupbyops(aggregrate_client):
    ...
    res_put_wrong_content_type = client.put(
        url, headers={'Content-Type': plain_text})
    ...
    res_put_wrong_params = client.put(url, query_string={
                                      "column": "first_name", "group_by": None}, headers={'Content-Type': 'application/json'})
    ...
    success_res = client.put(url, query_string={"column": "count", "group_by": "last_name"}, headers={
